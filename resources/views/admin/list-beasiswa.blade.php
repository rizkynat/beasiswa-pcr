            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row col-12">
                        <a href="/h/admin/tambah/beasiswa" class="btn btn-icon-split mb-4" type="button" style="--bs-btn-padding-y: .25rem;background-color:#00465e;color:white;--bs-btn-padding-x: .25rem;">
                                ...
                                <thead>
                                    ...
                                    @foreach($beasiswas as $beasiswa)
                                        <tr>
                                            ...
                                            <td>{{$beasiswa->awal_daftar}}</td>
                                            <td>{{$beasiswa->akhir_daftar}}</td>
                                            <td>{{$beasiswa->pengumuman}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
